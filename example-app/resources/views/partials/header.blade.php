        ...
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <div class="aa-header-top-right">
                    ...
                    <li class="hidden-xs"><a href="{{ route('wishlist.show') }}"><span class="wishlist-quantity" style="color: red;">{{ WishlistQuantity() }}</span>Wishlist</a>
                    </li>
                    <li class="hidden-xs"><a href="{{ route('order.list') }}">My Cart</a></li>
                    <li class="hidden-xs"><a href="{{ route('order.chekout') }}">Checkout</a></li>
