...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('adminadmin.dashboard') }}" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge test">0</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('adminadmin.dashboard') }}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('adminadmin.dashboard') }}" class="nav-link 
              @if (url()->current() == route('adminadmin.dashboard'))
                active
              @endif ">
...
<script src="https://js.pusher.com/7.0/pusher.min.js"></script>
  <script type="text/javascript">
    ...
    var pusher = new Pusher('2f1611e87190fad4d25f', {
      cluster: 'ap1'
    });
